---
name: xapi
description: Access real-time external data, managed sandboxes, and hosted Workers via the xapi CLI. Use for xAPI social/search/crypto/AI calls, Sandbox compute, AI or WebSocket Gateway setup, and deploying JavaScript or persistent Agents to xAPI Workers.
metadata:
